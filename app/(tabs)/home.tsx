  ...
  if (!currentUser) {
    return (
      <SafeAreaView className="flex-1 bg-[#2D2D2D] justify-center items-center px-6">
        <Ionicons name="flower" size={64} color="#BFFF00" style={{ marginBottom: 20 }} />
        ...
        <TouchableOpacity
          ...
          className="bg-[#BFFF00] px-8 py-4 rounded-full"
        >
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#2D2D2D]">
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View className="bg-[#2D2D2D] px-6 pt-4 pb-6">
          {/* Top Bar */}
          <View className="flex-row justify-between items-center mb-6">
            <View className="flex-row items-center">
              <Ionicons name="flower" size={28} color="#BFFF00" />
            ...
            <View className="flex-row items-center gap-4">
              ...
              <TouchableOpacity onPress={() => router.push("/profile")}>
                <Image
                  ...
                  style={{ borderWidth: 2, borderColor: '#BFFF00' }}
                />
              </TouchableOpacity>
            </View>
          </View>
          ...
          {/* Date Info */}
          <View className="flex-row items-center">
            <Ionicons name="calendar-outline" size={20} color="#BFFF00" />
        ...
        <View className="bg-[#F5F1E8] rounded-t-3xl px-6 pt-6 pb-8">
          {/* Month Header */}
          <View className="flex-row justify-between items-center mb-6">
            <View>
              <Text className="text-[#6B2D8C] text-3xl font-bold">
            ...
            <View className="flex-row gap-2">
              ...
              >
                <Ionicons name="chevron-back" size={20} color="#6B2D8C" />
              </TouchableOpacity>
              <TouchableOpacity
                className="p-2 bg-white rounded-full"
                onPress={() => {
              ...
              >
                <Ionicons name="chevron-forward" size={20} color="#6B2D8C" />
              </TouchableOpacity>
            </View>
          </View>
          ...
          <View className="flex-row flex-wrap">
            ...
            {monthDays.map((day) => (
              ...
              >
                {day.hasActivity ? (
                  <View className="bg-[#BFFF00] rounded-full w-10 h-10 items-center justify-center shadow-sm">
        ...
        <View className="bg-white px-6 py-8">
          <View className="flex-row items-center justify-between mb-4">
            <Text className="text-[#6B2D8C] text-2xl font-bold">Today&apos;s Tasks</Text>
            <View className="bg-[#BFFF00] px-3 py-1 rounded-full">
          ...
          {tasks.length === 0 ? (
            <View className="py-8 items-center">
              <Ionicons name="checkmark-circle-outline" size={48} color="#BFFF00" />
            ...
            tasks.map((task) => (
              <TouchableOpacity
                ...
                style={{
                  borderLeftColor: task.completed ? '#9CA3AF' : '#BFFF00',
                  shadowColor: '#000',
                ...
                <View className="flex-row items-center p-4">
                  <View className="mr-3">
                    <Ionicons
                      ...
                      size={28}
                      color={task.completed ? "#9CA3AF" : "#BFFF00"}
                    />
                  </View>
                  <Text
          ...
          <KeyboardAvoidingView behavior="padding">
            <View className="flex-row items-center mt-4">
              <TextInput
                className="flex-1 bg-[#F5F1E8] px-4 py-4 rounded-2xl text-[#2D2D2D] text-base"
        ...
        <View className="bg-[#F5F1E8] px-6 py-8">
          <Text className="text-[#6B2D8C] text-2xl font-bold mb-4">Your Progress</Text>
          <View className="flex-row gap-3">
            <View className="flex-1 bg-white rounded-2xl p-4 items-center shadow-sm">
              <Ionicons name="flame" size={32} color="#BFFF00" />
          ...
          <View className="mt-3 bg-white rounded-2xl p-4 items-center shadow-sm">
            <Ionicons name="time" size={32} color="#BFFF00" />
            <Text className="text-[#2D2D2D] text-2xl font-bold mt-2">
              {stats.screenTime}
            </Text>
